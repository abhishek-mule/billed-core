...
function applyRoutingRules(response: NextResponse, pathname: string, hasAuth: boolean, hasTenant: boolean, requestUrl: string): NextResponse {
  ...
  const isAppRoute = pathname.startsWith('/dashboard') || pathname.startsWith('/sales') || pathname.startsWith('/udhar') || pathname.startsWith('/invoices') || pathname.startsWith('/parties') || pathname.startsWith('/settings') || pathname.startsWith('/reports') || pathname.startsWith('/pos') || pathname.startsWith('/pricing') || pathname.startsWith('/more') || pathname.startsWith('/pulse') || pathname.startsWith('/cashflow') || pathname.startsWith('/products') || pathname.startsWith('/purchases') || pathname.startsWith('/recovery') || pathname.startsWith('/notifications')
...
export const config = {
  matcher: ['/((?!_next/static|_next/image|favicon.ico|.*\\..*|api/auth|api/events|api/tenants|api/merchants|api/meta|auth/callback).*)'],
}
