...
export type PilotEventKind = 'connect' | 'reminder_sent' | 'customer_replied' | 'merchant_app_reply' | 'message_status' | 'payment_created' | 'payment_received' | 'automation_stopped' | 'unattributed_webhook' | 'webhook_error';
